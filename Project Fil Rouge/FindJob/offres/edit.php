            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <select id="statut_offre" name="statut_offre">
                        <option value="Publiée" <?php echo $offre['statut_offre'] === 'Publiée' ? 'selected' : ''; ?>>Publiée</option>
                        <option value="Brouillon" <?php echo $offre['statut_offre'] === 'Brouillon' ? 'selected' : ''; ?>>Brouillon</option>
                        <option value="Fermée" <?php echo $offre['statut_offre'] === 'Fermée' ? 'selected' : ''; ?>>Fermée</option>
                    </select>
                </div>
